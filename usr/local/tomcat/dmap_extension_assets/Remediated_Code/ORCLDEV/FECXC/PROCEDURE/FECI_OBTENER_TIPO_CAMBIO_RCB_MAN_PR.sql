...
and cod_moneda = 'USD'
fetch next 1 rows only;
select_fec_dol := select_fec_dol_opc;/* dmap converted statement start */
exception
...
and cod_moneda = p_codigo_mon
fetch next 1 rows only;
select_fec_ori := select_fec_alt;/* dmap converted statement start */
...
and cod_moneda = 'USD'
fetch next 1 rows only;
select_fec_dol := select_fec_dol_alt;/* dmap converted statement start */
