...
perform_fec_ori         timestamp(0);
perform_val_ori         numeric;
perform_fec_dol         timestamp(0);
perform_val_dol         numeric;
begin 
...
RAISE NOTICE '% %', r.fec_tc_origen, r.tipo_cambio_dolar;/* dmap converted statement end */
