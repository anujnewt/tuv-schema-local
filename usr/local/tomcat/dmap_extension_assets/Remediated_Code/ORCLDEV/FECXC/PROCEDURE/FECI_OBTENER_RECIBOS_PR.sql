create or replace procedure fecxc."feci_obtener_recibos_pr"  ( p_ver varchar, p_fecha_inicio timestamp(0), p_fecha_fin timestamp(0), p_tipo_recibo varchar default null, p_empresa varchar default null, p_folio_inicial numeric default null, p_folio_final numeric default null, p_clase_cliente varchar default null,
INOUT feci_cursor refcursor default null) as $body$
declare
